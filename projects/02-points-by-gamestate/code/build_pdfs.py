...
# Derive the project number from the folder name, e.g.
#   "01-penalty-analysis"     -> "01"
#   "02-points-by-gamestate"  -> "02"
# Falls back to "??" if the folder doesn't start with digits.
_m = re.match(r"^(\d+)", PROJECT_DIR.name)
PROJECT_NUM = _m.group(1) if _m else "??"
...
<head>
<meta charset="UTF-8">
<title>Methodology — Renball Project {PROJECT_NUM}</title>
<style>{METHODOLOGY_CSS}</style>
</head>
<body>
<div class="renball-mark"><span>ren</span><span class="ball">ball</span><span class="sep">METHODOLOGY · PROJECT {PROJECT_NUM}</span></div>
{body_html}
</body>
</html>
"""
